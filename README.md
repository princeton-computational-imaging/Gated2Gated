...
This repository contains code for [Gated2Gated : Self-Supervised Depth Estimation from Gated Images](). Dataset will also be published soon.
...
```
git clone https://github.com/amanwalia123/gated2gated
```
